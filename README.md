...
To build the social proof section according to the given designs as close as possible.
The users should be able to:
- View the optimal layout depending on their device's screen size
### Links

- Solution URL: [Open GitHub repository](https://github.com/YariMorcus/social-proof-section)
- Live Site URL: [open GitHub Pages of repository](https://yarimorcus.github.io/social-proof-section/)
